      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url(); ?>admin/admin">
                ...
                <span class="nav-link-text">Sms Seytem</span>
              </a>
            </li>
          </ul>
          <!-- Divider -->
          ...
          <ul class="navbar-nav mb-md-3">
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url(); ?>admin/examSetup">
                <i class="ni ni-spaceship"></i>
                <span class="nav-link-text">Exam Setup</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url(); ?>admin/questionSetup">
                <i class="ni ni-spaceship"></i>
                <span class="nav-link-text">Question Setup</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url(); ?>admin/questionPaperSetup">
                <i class="ni ni-spaceship"></i>
                <span class="nav-link-text">Question Paper Setup</span>
              </a>
            </li>
            <?php if($user->type == 1){?> <!-- if admin -->
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url(); ?>admin/userSetup">
                <i class="ni ni-circle-08 text-pink"></i>
                <span class="nav-link-text">User Setup</span>
              </a>
            </li>
            <?php } ?>
            <?php if($user->type == 1){?> <!-- if admin -->
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url(); ?>admin/groupSetup">
                <i class="ni ni-spaceship"></i>
                <span class="nav-link-text">Group Setup</span>
              </a>
            </li>
            <?php } ?>
            <?php if($user->type == 1){?> <!-- if admin -->
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url(); ?>admin/classSetup">
                <i class="ni ni-spaceship"></i>
                <span class="nav-link-text">Class Setup</span>
              </a>
            </li>
            <?php } ?>
            <?php if($user->type == 1){?> <!-- if admin -->
            <li class="nav-item">
              <a class="nav-link" href="<?php echo base_url(); ?>admin/subjectSetup">
                <i class="ni ni-spaceship"></i>
                <span class="nav-link-text">Subject Setup</span>
              </a>
            </li>
            <?php } ?>
            <!-- <li class="nav-item">
              ...
              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <div class="media align-items-center">
                  ...
                  <div class="media-body  ml-2  d-none d-lg-block">
                    <span class="mb-0 text-sm  font-weight-bold"><?php $user = $this->users->get_user_by_id($this->tank_auth->get_user_id(), TRUE); echo $user->firstname; ?></span>
                  </div>
                </div>
              </a>
