                  ...
                  <div class="row">
                      <div class="col-lg-6 col-md-12 col-sm-12">
                          <div class="form-group">
                              ...
                              <textarea class="form-control" id="option1" name="option1" rows="3"></textarea>
                          </div>
                      </div>
                      <div class="col-lg-6 col-md-12 col-sm-12">
                          <div class="form-group">
                              <label for="option2">Option-2</label>
                              <textarea class="form-control" id="option2" name="option2" rows="3"></textarea>
                          </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-6 col-md-12 col-sm-12">
                          <div class="form-group">
                              ...
                              <textarea class="form-control" id="option3" name="option3" rows="3"></textarea>
                          </div>
                      </div>
                      <div class="col-lg-6 col-md-12 col-sm-12">
                          <div class="form-group">
                              <label for="option4">Option-4</label>
                              <textarea class="form-control" id="option4" name="option4" rows="3"></textarea>
                          </div>
                      </div>
                    </div>
                <div class="row">
