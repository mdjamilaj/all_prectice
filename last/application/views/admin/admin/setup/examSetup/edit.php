...
<div class="container-fluid">
    <div class="row">
        <div class="col-xl-12">
          <div class="card mt-5">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Exam Setup Edit</h3>
                </div>
          ...
          <form action="<?php echo base_url(); ?>admin/examSetup/update" method="POST">
          <div class="row">
                    <div class="col-lg-3 col-md-6 col-sm-12">
                          <div class="form-group">
                              ...
                              <div class="flatpickr form__group field" id="startDate"  class="form__field">
                                  <input value="<?php echo $userData->exam_start_datetime; ?>" data-input required  type="text" name="exam_start_datetime" id="exam_start_datetime" autocomplete="off" placeholder="Select Start Date Time" class="form-control"> <!-- input is mandatory -->
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                          <div class="form-group">
                              ...
                              <div class="flatpickr form__group field" id="endDate"  class="form__field">
                                  <input value="<?php echo $userData->exam_end_datetime; ?>"  data-input required  type="text" name="exam_end_datetime" id="exam_end_datetime" autocomplete="off" placeholder="Select End Date Time" class="form-control"> <!-- input is mandatory -->
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input value="<?php echo $userData->number_of_question; ?>" type="number" name="number_of_question" id="number_of_question" placeholder="Enter number od question" class="form-control" required>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <div class="form-group">
                            <label for="total_time">Total Times <sub>(munites)</sub></label>
                            <input value="<?php echo $userData->total_time; ?>" type="number" name="total_time" id="total_time" placeholder="Enter total time" class="form-control" required>
                        </div>
                    </div>
                  </div>    
                  <div class="row">
                      <div class="col-lg-3 col-md-6 col-sm-12">
                          <div class="form-group">
                              ...
                              <select type="text" name="question_marks" id="question_marks" placeholder="Enter question marks" class="form-control" required>
                                <option <?php if($userData->question_marks == 0){echo "selected";} ?> value="0">Singel</option>
                                <option <?php if($userData->question_marks == 1){echo "selected";} ?> value="1">Multiple</option>
                              </select>
                          </div>
                      </div>
                      <div class="col-lg-3 col-md-6 col-sm-12">
                          <div class="form-group">
                              ...
                              <select type="text" name="question_paper_type" id="question_paper_type" placeholder="Enter question paper type" class="form-control" required>
                                <option <?php if($userData->question_paper_type == 0){echo "selected";} ?> value="0">Singel Question</option>
                                <option <?php if($userData->question_paper_type == 1){echo "selected";} ?> value="1">All Question</option>
                              </select>
                          </div>
                      </div>
                      <div class="col-lg-3 col-md-6 col-sm-12">
                          <div class="form-group">
                              ...
                              <input  value="<?php echo $userData->total_marks; ?>" type="number" name="total_marks" id="total_marks" placeholder="Enter total marks" class="form-control" required>
                          </div>
                      </div>
                      <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="form-group">
                                <label for="negative_marks">Negative Marks <sub>(Singel Question)</sub></label>
                                <input value="<?php echo $userData->negative_marks; ?>" type="number" name="negative_marks" id="negative_marks" placeholder="Enter negative marks" class="form-control" required value="0">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                      <div class="col-lg-12 col-md-6 col-sm-12">
                          <div class="form-group">
                              ...
                              <textarea class="form-control" id="title" name="title" rows="4"><?php echo $userData->title; ?></textarea>
                          </div>
                      </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 mb-5">
                        <div class="form-group mt-l">
                            <input type="hidden" name="id" value="<?php echo $userData->exam_setup_id; ?>">
