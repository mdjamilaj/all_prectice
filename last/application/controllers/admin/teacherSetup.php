...
class teacherSetup extends CI_Controller
{
	...
	public function index($page=false)
	{
        ...
        $data['teachers'] = $this->db->where('teacher', 1)->get('users')->result();
        $this->load->library('pagination');
        $config['base_url'] = base_url('admin/teacherSetup/index');
        $config['total_rows'] = $this->db->where('teacher', 1)->count_all('users');
        $config['per_page'] = 10;
        ...
        $this->render_page('admin/admin/setup/teacherSetup/index', $data);
